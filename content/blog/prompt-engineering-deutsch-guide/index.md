...
cover:
  image: ""
  alt: "Prompt Engineering Deutsch Guide"
  caption: "Gute Prompts sind wie gute Kommunikation – klar, konkret, kontextreich"
  relative: false
ShowToc: true
TocOpen: true
---
...
```
Du bist ein erfahrener Tech-Blogger mit Fokus auf KI-Tools für deutsche KMUs.

Aufgabe: Schreibe einen Blog-Artikel über "Die 5 besten KI-Tools für deutsche Handwerker 2026"

Kontext: Meine Leser sind Inhaber von Handwerksbetrieben (10-50 Mitarbeiter), technisch interessiert aber keine Experten.

Ziel: Sie sollen erkennen, dass KI auch im Handwerk Zeit spart – und mindestens ein Tool ausprobieren.

Format: 
- Einleitung (ca. 150 Wörter)
- 5 Tools im Detail (je 200 Wörter)
- Fazit mit Handlungsaufforderung
- H2- und H3-Überschriften
- Du-Ton, praxisnah, ohne Fachjargon

Einschränkungen:
- Nur Tools, die auf Deutsch verfügbar sind
- Keine US-zentrierten Beispiele
- Konkrete Use-Cases aus dem Handwerks-Alltag
- Maximal 1500 Wörter gesamt
```

### Beispiel 2: Bewerbungs-Anschreiben

```
Du bist HR-Manager bei einem deutschen Technologie-Unternehmen und hast 1000+ Bewerbungen gelesen.

Aufgabe: Schreibe ein Anschreiben für eine Bewerbung als "Digital Marketing Manager"

Kontext: 
- Bewerber: 32 Jahre, 5 Jahre Erfahrung in B2B-Marketing
- Aktuell: Marketing Manager bei einem SaaS-Startup in München
- Bewirbt sich bei: Mittelständischer Tech-Konzern (500 MA) in Stuttgart
- Stärken: Kampagnen-Management, Marketing-Automation, SEO/SEM

Ziel: Das Anschreiben soll neugierig machen und zum Vorstellungsgespräch einladen.

Format:
- Klassischer Briefaufbau (Anrede, Einleitung, Hauptteil, Schluss)
- 3-4 Absätze, maximal 350 Wörter
- Formeller Ton, aber nicht steif

Einschränkungen:
- Keine Floskeln wie "hiermit bewerbe ich mich"
- Nicht wiederholen, was im Lebenslauf steht
- Konkrete Erfolge nennen (mit Zahlen)
- Bezug auf das Unternehmen herstellen
```

### Beispiel 3: E-Mail an Kunden

```
Du bist ein deutscher Business-Communication-Experte für E-Mail-Marketing.

Aufgabe: Schreibe eine Follow-up-E-Mail nach einem Erstgespräch mit einem potenziellen Kunden.

Kontext:
- Dienstleistung: KI-Beratung für E-Commerce-Unternehmen
- Gespräch war positiv, Kunde interessiert an Automatisierung
- Kunde: Online-Shop für Mode (30 Mio. Umsatz/Jahr)
- Nächster Schritt: Angebot erstellen

Ziel: Kunde soll das Angebot anfordern und positiv gestimmt bleiben.
...
Einschränkungen:
- Nicht zu verkaufend wirken
- Auf Deutsch, Sie-Form
- Maximal 200 Wörter
- Kein Spam-Vokabular ("kostenlos", "Angebot", "Rabatt")
```

---

## Häufige Fehler bei deutschen Prompts
...
- **R**olle – Wer ist die KI?
- **A**ufgabe – Was genau tun?
- **K**ontext – Welche Infos braucht sie?
- **Z**iel – Was soll erreicht werden?
- **F**ormat – Wie soll es aussehen?
- **E**inschränkungen – Was vermeiden?
