...
summary: "Wie du in 4 einfachen Schritten eine persönliche Prompt Library aufbaust, die dir stundenlang Arbeit spart. Mit Vorlagen, Kategorien und den besten Tools."
tags: ["Prompt Engineering", "KI-Tools", "Productivity", "ChatGPT"]
...
| Feld | Beschreibung |
|------|-------------|
| **Titel** | Kurz und eindeutig, z.B. "Artikel-Outliner" |
| **Prompt-Text** | Der eigentliche Prompt |
| **Kategorie** | Zuordnung zu deinem Kategorie-System |
| **Erstellt** | Datum der Erstellung |
| **Beschreibung** | Wofür du den Prompt nutzt |
| **Erfolg** | Bewertung oder Notes |
| **Tool** | Für welches KI-Tool optimiert (optional) |
...
```
Erstelle eine [Länge]-Zusammenfassung von [Thema] für [Zielgruppe].
Der Ton sollte [Ton] sein und folgende Aspekte enthalten: [Aspekte].
```
